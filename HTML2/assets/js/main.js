...
(function(){
    ...
    var mkr = new google.maps.LatLng(28.5544781, 77.2682297);
    var cntr = (isMobile) ? mkr : new google.maps.LatLng(28.5544781, 77.2682297);
...
/*------------------------------------------
 job opening
 ------------------------------------------*/
$( '.js-crs-job-item' ).on( 'click', function() {
...
/*------------------------------------------
 culture pics
 ------------------------------------------*/
  window.currentImageSlider = new ImageSlider( '.test', '.crs-image-item', 500 );
